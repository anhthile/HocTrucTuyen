   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete playlist" class="delete-btn" onclick="return confirm('xóa danh sách phát này?');" name="delete">
         </form>
      </div>
   </div>
   <?php
...
<section class="contents">
   ...
   <h1 class="heading">Danh sách videos</h1>
