...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('xóa video này ?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Không tìm thấy nội dung!</p>';
      }
   }else{
      echo '<p class="empty">Vui lòng nhập tuef khóa cần tìm kiếm !</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('xóa danh sách phát này?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">xem danh sách</a>
      </div>
      <?php
         } 
      }else{
         ...
         echo '<p class="empty">Xin vui lòng tìm kiếm một cái gì đó!</p>';
      }
      ?>
