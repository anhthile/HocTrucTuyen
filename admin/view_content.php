...
<section class="view-content">
   ...
   <?php
      ...
      echo '<p class="empty">Chưa có nội dung nào được thêm vào! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm video</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Xóa bình luận này?');">delete comment</button>
         </form>
      </div>
      <?php
       }
