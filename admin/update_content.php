...
if(isset($_POST['update'])){
   ...
   $message[] = 'Nội dung được cập nhật!';
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Chọn danh sách phát--</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Chưa có danh sách phát nào được tạo!</option>';
         }
         ?>
      </select>
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">xem nội dung</a>
   ...
   <?php
         ...
         echo '<p class="empty">Video không được tìm thấy! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">thêm videos</a></p>';
      }
   ?>
