...
<section class="playlists">
   ...
   <h1 class="heading">Danh sách phát đã thêm</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Tạo danh sách</h3>
         <a href="add_playlist.php" class="btn">Thêm danh sách</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Xóa danh sách phát này?');" name="delete">
         </form>
      ...
      <?php
         ...
         echo '<p class="empty">Chưa có danh sách phát nào được thêm vào!</p>';
      }
      ?>
