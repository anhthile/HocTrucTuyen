...
<section class="liked-videos">
   ...
   <h1 class="heading">Thích video</h1>
   ...
   <?php
            ...
            echo '<p class="emtpy">Nội dung không được tìm thấy!</p>';         
         }
      }
   }else{
      echo '<p class="empty">Chưa có gì được thêm vào lượt thích!</p>';
   }
   ?>
