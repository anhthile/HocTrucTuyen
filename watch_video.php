...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'đã xóa khỏi lượt thích!';
      }else{
...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Đã chỉnh sửa bình luận thành công!';
   }
...
<section class="edit-comment">
   <h1 class="heading">Chỉnh sữa bình luận</h1>
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Hủy chỉnh sữa</a>
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">xem danh sách</a>
         <?php
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Chỉnh sữa bình luận</button>
