...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Số lượt thích : <span><?= $total_likes; ?></span></p>
         <a href="likes.php" class="inline-btn">Xem lượt thích</a>
         <p>Số bình luận : <span><?= $total_comments; ?></span></p>
         <a href="comments.php" class="inline-btn">xem bình luận</a>
         <p>Lưu danh sách : <span><?= $total_bookmarked; ?></span></p>
         <a href="bookmark.php" class="inline-btn">Xem dấu trang</a>
      </div>
      <?php
         }else{ 
      ?>
      ...
      <div class="box">
         ...
         <div class="flex">
            <a href="search_course.php?"><i class="fas fa-code"></i><span>Nhà phát triển</span></a>
            <a href="#"><i class="fas fa-chart-simple"></i><span>Kinh doanh</span></a>
            <a href="#"><i class="fas fa-pen"></i><span>Thiết kế</span></a>
            <a href="#"><i class="fas fa-chart-line"></i><span>Tiếp thị</span></a>
            <a href="#"><i class="fas fa-music"></i><span>Âm nhạc</span></a>
            <a href="#"><i class="fas fa-camera"></i><span>Nhiếp ảnh</span></a>
      ...
      <div class="box tutor">
         ...
         <p>Hãy trở thành một giáo viên giỏi,vui vẻ nhiệt huyết và thân thiện</p>
         <a href="admin/register.php" class="inline-btn">Bắt đầu nào!!!</a>
      </div>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">xem danh sách</a>
      </div>
      <?php
         }
      }else{
